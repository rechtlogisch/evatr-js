 ...
 */
export const DEFAULT_HOST = 'https://api.evatr.vies.bzst.de';
export const DEFAULT_BASE_URL = DEFAULT_HOST + '/app/v1';

/**
 * API endpoints
 */
export const ENDPOINTS = {
  VALIDATION: DEFAULT_BASE_URL + '/abfrage',
  STATUS_MESSAGES: DEFAULT_BASE_URL + '/info/statusmeldungen',
  EU_MEMBER_STATES: DEFAULT_BASE_URL + '/info/eu_mitgliedstaaten',
} as const;
 ...
 */
export const QUALIFIED_RESULT_CODES = {
